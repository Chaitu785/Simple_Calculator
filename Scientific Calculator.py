...
label1=tk.Label(window,text="CALCULATOR",relief=RIDGE,borderwidth=9,width=39,fg="lime green",bg="black")
label1.config(font=('Arial bold', 13))
label1.place(x=0,y=0)
# Last line Label
label1=tk.Label(window,text="~ Designed by Chaitanya ",relief=RIDGE,borderwidth=5,width=49,fg="lime green",bg="black")
label1.config(font=('Arial bold', 10))
label1.place(x=0,y=582)

# First Entry Box
text1 = tk.Entry(master=window, width=27,relief=SUNKEN,borderwidth=16,bg="white")
text1.config(font=('Arial bold', 19))
text1.place(x=0, y=70)
# Second Entry Box
text2 = tk.Entry(master=window, width=27,relief=RIDGE,borderwidth=16,bg="white")
text2.config(font=('Arial bold', 19))
text2.place(x=0, y=135)

# Frame to design Keys
frame = Frame(master=window,width=400,height=400,bg="white")
...
def rating():
    ...
    #webbrowser.get(path2).open('chaitanya.weebly.com/feedback')
    webbrowser.open('chaitanya.weebly.com/feedback') 
    close()
# Function to open personal website
def website():
    #path1 = '"C://Program Files/Mozilla Firefox/firefox.exe" %s'
    #webbrowser.get(path1).open('chaitanya.weebly.com')
    webbrowser.open('chaitanya.weebly.com') 
...
but28 = tk.Button(frame1, text="Reset",width=8,height=1,borderwidth=5, relief=tk.RAISED, fg="black", bg="grey",command=reset)
...
#ROW 1
but1 = tk.Button(frame, text="AC",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="black", bg="grey",command=delall)
but1.config(font=('Arial bold', 20))
but1.grid(row = 0, column = 0)

but2 = tk.Button(frame, text="C",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="black", bg="red",command=clr1)
but2.config(font=('Arial bold', 20))
but2.grid(row = 0, column = 1)

but3 = tk.Button(frame, text="%",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="black", bg="grey")
but3.config(font=('Arial bold', 20))
but3.grid(row = 0, column = 2)

but4 = tk.Button(frame, text="/", width=3,height=1,borderwidth=12,relief=tk.RAISED, fg="black", bg="grey",command=bt4)
but4.config(font=('Arial bold', 20))
but4.grid(row = 0, column = 3)

but5 = tk.Button(frame, text="(", width=3,height=1,borderwidth=12,relief=tk.RAISED, fg="black", bg="grey",command=bt5)
but5.config(font=('Arial bold', 20))
but5.grid(row = 0, column = 4)

#ROW 2
but6 = tk.Button(frame, text="7",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="white", bg="black",command=bt6)
but6.config(font=('Arial bold', 20))
but6.grid(row = 1, column = 0)

but7 = tk.Button(frame, text="8",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="white", bg="black",command=bt7)
but7.config(font=('Arial bold', 20))
but7.grid(row = 1, column = 1)

but8 = tk.Button(frame, text="9",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="white", bg="black",command=bt8)
...
#ROW 3
but11 = tk.Button(frame, text="4",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="white", bg="black",command=bt11)
but11.config(font=('Arial bold', 20))
but11.grid(row = 2, column = 0)

but12 = tk.Button(frame, text="5",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="white", bg="black",command=bt12)
but12.config(font=('Arial bold', 20))
but12.grid(row = 2, column = 1)

but13 = tk.Button(frame, text="6",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="white", bg="black",command=bt13)
...
#ROW 4
but16 = tk.Button(frame, text="1",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="white", bg="black",command=bt16)
but16.config(font=('Arial bold', 20))
but16.grid(row = 3, column = 0)

but17 = tk.Button(frame, text="2",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="white", bg="black",command=bt17)
but17.config(font=('Arial bold', 20))
but17.grid(row = 3, column = 1)

but18 = tk.Button(frame, text="3",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="white", bg="black",command=bt18)
...
#ROW 5
but21 = tk.Button(frame, text="00",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="white", bg="black",command=bt21)
but21.config(font=('Arial bold', 20))
but21.grid(row = 4, column = 0)

but22 = tk.Button(frame, text="0",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="white", bg="black",command=bt22)
but22.config(font=('Arial bold', 20))
but22.grid(row = 4, column = 1)

but23 = tk.Button(frame, text=".",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="black", bg="white",command=bt23)
